...
title: Existing Frameworks Community Working Groups
tab-title: Existing Frameworks Community Working Groups
permalink: /20x/working-groups/existing-frameworks/
redirect_from: /working-groups/existing-frameworks/
...
In a world where FedRAMP is relying on automated validations to the greatest
extent possible, simplifying the documentation and management requirements will
require us to think innovatively about how we leverage existing commercial
...
group will investigate opportunities to leverage commercial frameworks that can
address some or all of the federal cloud security requirements without creating
redundant compliance processes. The evaluation will focus on identifying
